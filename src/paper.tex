...
More recently, the NLP community has seen huge popularity in heavily adopting pretraining-based langauge models. The latest development on this is transformers-based models including BERT. BERT, or Bidirectional Encoder Representations from Transformers (Devlin et al., 2018), is a pretrained language model that can achieve state-of-the-art results on a variety of natural language processing tasks.
